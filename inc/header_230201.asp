		...
		<div class="headerBox">
			...
			<nav>
				<ul id="gnb" class="depth1">
					...
					<li>
						<a href="/kr/sub/products/list.asp?p_cate=10" data-sub_url="/kr/sub/products/detail.asp">PRODUCTS</a>
...
<!-- 							<li><a href="/kr/sub/ir/notice.asp" data-sub_url="/kr/sub/ir/noticeView.asp">공지사항</a></li> -->
					...
					<li>
						...
						<ul class="depth2 menu05">
							<li><a target="_blank" href="http://www.globalzeus.com/recruit/index.asp">채용 홈페이지 바로가기 <i class="xi-external-link"></i></a></li>
						</ul>
					</li>
					<li>
			...
			<div class="pathBox">
				<div class="width1400">
					<ul class="path">
						...
						<%
							Set objView = Server.CreateObject("ADODB.Recordset")
							SQL = "SELECT idx, p_name, p_memo, p_image1 FROM tbl_prod WHERE idx != '' AND p_hide = '0' AND p_cate = '"&p_cate1&"' AND p_cate2 = '"&p_cate2&"' ORDER BY p_lev ASC "
							objView.open SQL, Dbcon, 1, 3
							If Not objView.eof Then arrRS = objView.getrows()
							objView.close
							Set objView = Nothing
						...
						<li class="detailPath">
							...
							<%
								For i = LBound(arrRS, 2) To UBound(arrRS, 2)
									...
									p_image	= arrRS(3,i)
							%>
								<li><a href="/kr/sub/products/detail.asp?p_idx=<%=p_idx%>"><%=p_name%></a></li>
							<%
								Next
								Erase arrRS
							%>
